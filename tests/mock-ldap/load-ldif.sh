...
ldapsearch -x -D "cn=admin,dc=chatopsknight,dc=com" -w $LDAP_ADMIN_PASSWORD -H $LDAP_URL -LLL -b "dc=chatopsknight, dc=com" -s sub "(userPrincipalName=jane.doe@chatopsknight.com)"
